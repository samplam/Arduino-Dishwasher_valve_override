...
Simple program that runs on an Attiny85. It's function is to override a Bosh 500 dishwasher filling valve TRIAC at very specific moments to maximize the draining of the dirty water during a cycle.

## Overview
This project is an Arduino-based that I made to override a Bosh 500 dishwasher filling valve TRIAC at very specific moments to maximize the draining of the dirty water during a cycle. The input signal from the drain pump has to be interfaced with an opto-coupler circuit. The output is a simple relay contact that short the TRIAC on the dishwasher's main PCB.
